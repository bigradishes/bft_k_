...
static void handle_icc(const char *s, const char *smsPdu)
{
    ...
    *linesave = NULL;
    ...
    if (err < 0)
    {
      ...
      // sleep(5);   //ÂèñÊ∂àÁù°5ÁßíÂäüËÉΩ    gelei  20161021  
...
/* added by RenYimin_2015-11-12 for AP and CP communication BEGIN */
    /**
     * @pthread_setname_np: pthread_setname_np()∫Õpthread_getname_np()£¨
     *  ø…“‘‘⁄Ω¯≥Ã÷–…Ë÷√∫Õ∂¡»°∆‰À˚œﬂ≥Ãµƒ√˚◊÷.
     * @pthread_self: ªÒµ√œﬂ≥Ã◊‘…ÌµƒID
     */
    /* …Ë÷√µ±«∞œﬂ≥Ãµƒ√˚◊÷ */
...
const RIL_RadioFunctions * RIL_Init(const struct RIL_Env *env, int argc, char **argv)
{
	...
	/**
	 * ¥¥Ω®œﬂ≥ÃÃÿ”–µƒ÷µ
	 * æﬂÃÂ∑√Œ :http://www.jianshu.com/p/d52c1ebf808a
	 */
