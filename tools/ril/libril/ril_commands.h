 ...
 */
    ...
    //added 5 request imfo by Boris for android5.1 20161128 20170401 
#ifdef ANDROID5_1_SUPPORTED     
    {RIL_REQUEST_GET_CELL_INFO_LIST, dispatchString, responseVoid},
    {RIL_REQUEST_SET_UNSOL_CELL_INFO_LIST_RATE, dispatchString, responseVoid},
    {RIL_REQUEST_SET_INITIAL_ATTACH_APN, dispatchString, responseVoid},
    {RIL_REQUEST_IMS_REGISTRATION_STATE, dispatchString, responseVoid},
    {RIL_REQUEST_IMS_SEND_SMS, dispatchString, responseVoid},
#endif 

    //added 22 requests imfo by Boris for android6.0 20170311 and 20170318,20170401
#ifdef ANDROID5_1_AND_6_0_SUPPORTED    

#if 0  //these are the original response,Boris,20170401
...
#else   //for temp compile error,20170318,none process,response unsupported ,Boris 20170401
	
	{RIL_REQUEST_SIM_TRANSMIT_APDU_BASIC, dispatchString, responseVoid},
	{RIL_REQUEST_SIM_OPEN_CHANNEL, dispatchString, responseInts},
	
	{RIL_REQUEST_NV_READ_ITEM, dispatchStrings, responseVoid},
	{RIL_REQUEST_NV_WRITE_ITEM, dispatchStrings, responseVoid},
	{RIL_REQUEST_NV_WRITE_CDMA_PRL, dispatchStrings, responseVoid},
	{RIL_REQUEST_NV_RESET_CONFIG, dispatchStrings, responseVoid},
	{RIL_REQUEST_SET_UICC_SUBSCRIPTION, dispatchStrings, responseVoid},
	{RIL_REQUEST_ALLOW_DATA, dispatchStrings, responseVoid},

#if 0  //20170509
	/**********chenjun 20170504**********/
	{RIL_REQUEST_START_LCE, dispatchStrings, responseVoid},
	{RIL_REQUEST_STOP_LCE, dispatchStrings, responseVoid},
	{RIL_REQUEST_PULL_LCEDATA, dispatchStrings, responseVoid},
	/************************************/
#endif

#if 1	//20170509
	{RIL_REQUEST_GET_HARDWARE_CONFIG, dispatchStrings, responseVoid},
	{RIL_REQUEST_SIM_AUTHENTICATION, dispatchStrings, responseVoid},
	{RIL_REQUEST_GET_DC_RT_INFO, dispatchStrings, responseVoid},
	{RIL_REQUEST_SET_DC_RT_INFO_RATE, dispatchStrings, responseVoid},
	{RIL_REQUEST_SET_DATA_PROFILE, dispatchStrings, responseVoid},
	{RIL_REQUEST_SHUTDOWN, dispatchStrings, responseVoid},
	{RIL_REQUEST_GET_RADIO_CAPABILITY, dispatchStrings, responseVoid},
	{RIL_REQUEST_SET_RADIO_CAPABILITY, dispatchStrings, responseVoid},
	{RIL_REQUEST_START_LCE, dispatchStrings, responseVoid},
	{RIL_REQUEST_STOP_LCE, dispatchStrings, responseVoid},
	{RIL_REQUEST_PULL_LCEDATA, dispatchStrings, responseVoid},
	{RIL_REQUEST_GET_ACTIVITY_INFO, dispatchStrings, responseVoid},
#endif	
	#endif 
	
	#if 0  //for DINGWEI NO SIM CARD BUG,20170317,BORIS
	{RIL_REQUEST_SIM_OPEN_CHANNEL, dispatchVoid, responseString},
	#endif
