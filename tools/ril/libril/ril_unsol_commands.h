...
*/
	...
	{RIL_UNSOL_SIM_PHONEBOOK_READY, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_PS_MOVING, responseInts, WAKE_PARTIAL},//add by wangna for psmoving
	{RIL_UNSOL_GSM_SERVING_CELL_INFO_ZTE, responseString, WAKE_PARTIAL},
	{RIL_UNSOL_NETWORK_REGISTER_FAILED_ON_TDLTE,responseVoid, WAKE_PARTIAL},
	{RIL_UNSOL_RESPONSE_PDP_SETUP_RESULT,responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_SIM_SMS_STORAGE_AVAILABLE,responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_PDP_SYN_CONTEXT, responseDataCallList, WAKE_PARTIAL},
    {RIL_UNSOL_LTE_MISSED, responseVoid, WAKE_PARTIAL},
     {RIL_UNSOL_SET_PS_AIRPLANE, responseInts, WAKE_PARTIAL},
     {RIL_UNSOL_SET_CS_AIRPLANE, responseInts, WAKE_PARTIAL},
